...
THZ_API void THZTensor_(maskedFill)(THZTensor *tensor, THByteTensor *mask,
                                    real value);
THZ_API void THZTensor_(maskedCopy)(THZTensor *tensor, THByteTensor *mask,
                                    THZTensor *src);
THZ_API void THZTensor_(maskedSelect)(THZTensor *tensor, THZTensor *src,
                                      THByteTensor *mask);

THZ_API void THZTensor_(indexSelect)(THZTensor *tensor, THZTensor *src, int dim,
                                     THLongTensor *index);
THZ_API void THZTensor_(indexCopy)(THZTensor *tensor, int dim,
                                   THLongTensor *index, THZTensor *src);
THZ_API void THZTensor_(indexFill)(THZTensor *tensor, int dim,
...
THZ_API void THZTensor_(cadd)(THZTensor *r_, THZTensor *t, real value,
                              THZTensor *src);
...
THZ_API void THZTensor_(addcmul)(THZTensor *r_, THZTensor *t, real value,
                                 THZTensor *src1, THZTensor *src2);
THZ_API void THZTensor_(addcdiv)(THZTensor *r_, THZTensor *t, real value,
                                 THZTensor *src1, THZTensor *src2);

THZ_API void THZTensor_(addmv)(THZTensor *r_, real beta, THZTensor *t,
                               real alpha, THZTensor *mat, THZTensor *vec);
THZ_API void THZTensor_(addmm)(THZTensor *r_, real beta, THZTensor *t,
                               real alpha, THZTensor *mat1, THZTensor *mat2);
THZ_API void THZTensor_(addr)(THZTensor *r_, real beta, THZTensor *t,
                              real alpha, THZTensor *vec1, THZTensor *vec2);

THZ_API void THZTensor_(match)(THZTensor *r_, THZTensor *m1, THZTensor *m2,
                               real gain);

THZ_API long THZTensor_(numel)(THZTensor *t);
THZ_API void THZTensor_(max)(THZTensor *values_, THLongTensor *indices_,
                             THZTensor *t, int dimension);
THZ_API void THZTensor_(min)(THZTensor *values_, THLongTensor *indices_,
                             THZTensor *t, int dimension);
...
THZ_API void THZTensor_(cross)(THZTensor *r_, THZTensor *a, THZTensor *b,
                               int dimension);
...
THZ_API void THZTensor_(reshape)(THZTensor *r_, THZTensor *t,
                                 THLongStorage *size);
THZ_API void THZTensor_(sort)(THZTensor *rt_, THLongTensor *ri_, THZTensor *t,
...
THZ_API void THZTensor_(cat)(THZTensor *r_, THZTensor *ta, THZTensor *tb,
                             int dimension);
...
THZ_API void THZTensor_(ltTensor)(THByteTensor *r_, THZTensor *ta,
                                  THZTensor *tb);
THZ_API void THZTensor_(leTensor)(THByteTensor *r_, THZTensor *ta,
                                  THZTensor *tb);
THZ_API void THZTensor_(gtTensor)(THByteTensor *r_, THZTensor *ta,
                                  THZTensor *tb);
THZ_API void THZTensor_(geTensor)(THByteTensor *r_, THZTensor *ta,
                                  THZTensor *tb);
THZ_API void THZTensor_(neTensor)(THByteTensor *r_, THZTensor *ta,
                                  THZTensor *tb);
THZ_API void THZTensor_(eqTensor)(THByteTensor *r_, THZTensor *ta,
                                  THZTensor *tb);
...
THZ_API void THZTensor_(std)(THZTensor *r_, THZTensor *t, int dimension,
                             int flag);
THZ_API void THZTensor_(var)(THZTensor *r_, THZTensor *t, int dimension,
                             int flag);
THZ_API void THZTensor_(norm)(THZTensor *r_, THZTensor *t, real value,
                              int dimension);
THZ_API void THZTensor_(renorm)(THZTensor *r_, THZTensor *t, real value,
...
THZ_API void THZTensor_(newDouble)(THZTensor *r_, THDoubleTensor *t,
                                   THDoubleTensor *src);
THZ_API void THZTensor_(newFloat)(THZTensor *r_, THFloatTensor *t,
                                  THFloatTensor *src);
